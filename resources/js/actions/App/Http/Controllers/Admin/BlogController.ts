...
/**
* @see \App\Http\Controllers\Admin\BlogController::bulkDestroy
 * @see app/Http/Controllers/Admin/BlogController.php:136
 * @route '/admin/blogs/bulk-destroy'
 */
 ...
 * @see app/Http/Controllers/Admin/BlogController.php:36
 * @route '/admin/blogs'
 */
 ...
 * @see app/Http/Controllers/Admin/BlogController.php:79
 ...
 * @see app/Http/Controllers/Admin/BlogController.php:129
 * @route '/admin/blogs/{blog}'
 */
...
const BlogController = { bulkDestroy, index, create, store, show, edit, update, destroy }
