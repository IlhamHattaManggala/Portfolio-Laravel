...
/**
* @see \App\Http\Controllers\Admin\ExperienceController::bulkDestroy
 * @see app/Http/Controllers/Admin/ExperienceController.php:86
 * @route '/admin/experience/bulk-destroy'
 */
...
bulkDestroy.definition = {
    methods: ["post"],
    url: '/admin/experience/bulk-destroy',
 ...
 * @see app/Http/Controllers/Admin/ExperienceController.php:12
 ...
 * @see app/Http/Controllers/Admin/ExperienceController.php:19
 ...
 * @see app/Http/Controllers/Admin/ExperienceController.php:0
 * @route '/admin/experience/{experience}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: '/admin/experience/{experience}',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @see app/Http/Controllers/Admin/ExperienceController.php:48
 * @route '/admin/experience/{experience}/edit'
 */
...
edit.definition = {
    methods: ["get","head"],
    url: '/admin/experience/{experience}/edit',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @see app/Http/Controllers/Admin/ExperienceController.php:55
 * @route '/admin/experience/{experience}'
 */
 ...
 * @see app/Http/Controllers/Admin/ExperienceController.php:79
 * @route '/admin/experience/{experience}'
 */
...
const ExperienceController = { bulkDestroy, index, create, store, show, edit, update, destroy }
