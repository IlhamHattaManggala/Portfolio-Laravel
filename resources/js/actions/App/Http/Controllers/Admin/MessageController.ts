...
/**
* @see \App\Http\Controllers\Admin\MessageController::bulkDestroy
 * @see app/Http/Controllers/Admin/MessageController.php:26
 * @route '/admin/messages/bulk-destroy'
 */
...
bulkDestroy.definition = {
    methods: ["post"],
    url: '/admin/messages/bulk-destroy',
 ...
 * @see app/Http/Controllers/Admin/MessageController.php:12
 ...
 * @see app/Http/Controllers/Admin/MessageController.php:19
...
const MessageController = { bulkDestroy, index, destroy }
