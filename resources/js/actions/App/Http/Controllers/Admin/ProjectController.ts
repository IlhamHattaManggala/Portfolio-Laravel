...
/**
* @see \App\Http\Controllers\Admin\ProjectController::bulkDestroy
 * @see app/Http/Controllers/Admin/ProjectController.php:84
 * @route '/admin/projects/bulk-destroy'
 */
...
bulkDestroy.definition = {
    methods: ["post"],
    url: '/admin/projects/bulk-destroy',
 ...
 * @see app/Http/Controllers/Admin/ProjectController.php:12
 ...
 * @see app/Http/Controllers/Admin/ProjectController.php:24
 * @route '/admin/projects'
 */
 ...
 * @see app/Http/Controllers/Admin/ProjectController.php:54
 * @route '/admin/projects/{project}'
 */
 ...
 * @see app/Http/Controllers/Admin/ProjectController.php:77
 * @route '/admin/projects/{project}'
 */
...
const ProjectController = { bulkDestroy, index, create, store, show, edit, update, destroy }
