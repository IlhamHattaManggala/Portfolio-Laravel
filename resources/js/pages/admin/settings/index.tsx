...
export default function Index({ settings }: IndexProps) {
  ...
  const { data, setData, post, processing, errors } = useForm({
    updates: [
      ...
      { key: "github_url", value: settings['github_url'] || "https://github.com/IlhamHattaManggala" },
      { key: "linkedin_url", value: settings['linkedin_url'] || "https://www.linkedin.com/in/ilham-hatta-manggala" },
      { key: "instagram_url", value: settings['instagram_url'] || "https://www.instagram.com/runtahhhh__/" },
